    ...
    <div style={{ fontFamily: "'Libre Baskerville', 'Georgia', serif", color: COLORS.darkText, background: COLORS.cream, minHeight: "100vh", overflowX: "hidden" }}>
      <style>{`
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .step-line { position: absolute; top: 24px; left: 50%; width: 100%; height: 2px; background: linear-gradient(90deg, ${COLORS.gold}, ${COLORS.gold}33); z-index: 0; }
        ...
        .why-card { display: flex; gap: 16px; align-items: flex-start; padding: 24px 28px; background: ${COLORS.white}; border-radius: 10px; border-left: 4px solid ${COLORS.gold}; transition: transform 0.3s; }
        ...
        .section-title { font-size: clamp(28px, 4vw, 42px); font-weight: 700; color: ${COLORS.darkGreen}; line-height: 1.2; margin-bottom: 16px; }
        .section-title-white { font-size: clamp(28px, 4vw, 42px); font-weight: 700; color: ${COLORS.white}; line-height: 1.2; margin-bottom: 16px; }
        ...
        @media (max-width: 768px) {
          ...
          .mobile-menu { display: flex; flex-direction: column; position: fixed; top: 0; right: 0; width: 280px; height: 100vh; background: ${COLORS.darkGreen}; padding: 80px 32px 32px; gap: 24px; z-index: 999; transform: translateX(100%); transition: transform 0.35s cubic-bezier(.22,1,.36,1); }
      ...
      <nav style={{
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto", padding: "16px 24px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 12, cursor: "pointer" }} onClick={() => scrollTo("hero")}>
            <GlobeIcon size={32} />
            <span className="sans" style={{ color: COLORS.white, fontWeight: 700, fontSize: 16, letterSpacing: 1.5, textTransform: "uppercase" }}>Asaase Trading Co.</span>
          </div>
      ...
      {/* ─── HERO ─── */}
      <section id="hero" style={{ background: `linear-gradient(165deg, ${COLORS.darkGreen} 0%, #163728 50%, ${COLORS.midGreen} 100%)`, position: "relative", overflow: "hidden", paddingTop: 120, paddingBottom: 80 }}>
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 24px", position: "relative", zIndex: 1 }}>
          <FadeIn>
            <div style={{ maxWidth: 720 }}>
              ...
              <h1 style={{ fontSize: "clamp(36px, 5.5vw, 64px)", fontWeight: 700, color: COLORS.white, lineHeight: 1.1, marginBottom: 24 }}>
                Your gateway to Ghana's commodity market
              </h1>
              <p className="sans" style={{ fontSize: 18, color: COLORS.paleGreen, lineHeight: 1.7, marginBottom: 36, maxWidth: 560 }}>
          ...
          <FadeIn delay={0.3}>
            <div className="hero-stats" style={{ display: "flex", gap: 0, marginTop: 64, borderRadius: 12, overflow: "hidden", background: "rgba(255,255,255,0.06)", backdropFilter: "blur(8px)", border: "1px solid rgba(255,255,255,0.08)" }}>
              {[
                { num: "GH₵38.95B", label: "Ghana food imports (2024)" },
                { num: "8", label: "Product categories" },
                { num: "200,000 MT", label: "Max order volume" },
              ].map((s, i) => (
                <div key={i} className="stat-card" style={{ flex: 1, borderRight: i < 2 ? "1px solid rgba(255,255,255,0.08)" : "none" }}>
                  <div style={{ fontSize: "clamp(22px, 3vw, 32px)", fontWeight: 700, color: COLORS.gold, marginBottom: 6 }}>{s.num}</div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 64, alignItems: "center" }}>
          <FadeIn>
            <div>
              ...
              <p className="sans" style={{ fontSize: 16, color: COLORS.medText, lineHeight: 1.8, marginBottom: 24 }}>
              ...
              <p className="sans" style={{ fontSize: 16, color: COLORS.medText, lineHeight: 1.8, marginBottom: 32 }}>
          ...
          <FadeIn delay={0.2}>
            <div style={{ background: `linear-gradient(145deg, ${COLORS.darkGreen}, ${COLORS.midGreen})`, borderRadius: 16, padding: 48, position: "relative", overflow: "hidden" }}>
              ...
              <div style={{ position: "relative", zIndex: 1 }}>
                <GlobeIcon size={64} color={COLORS.gold} />
                <div style={{ marginTop: 24, fontSize: 48, fontWeight: 700, color: COLORS.gold, lineHeight: 1 }}>10+</div>
      ...
      {/* ─── PRODUCTS ─── */}
      <section id="products" style={{ background: COLORS.white, padding: "100px 24px" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          <FadeIn>
            <div style={{ textAlign: "center", marginBottom: 56 }}>
              ...
              <p className="sans" style={{ fontSize: 16, color: COLORS.lightText, maxWidth: 560, margin: "0 auto" }}>
          ...
          <FadeIn delay={0.3}>
            <div className="sans" style={{ textAlign: "center", marginTop: 40, padding: "20px 24px", background: COLORS.softGreen, borderRadius: 10, fontSize: 14, color: COLORS.midGreen }}>
      ...
      {/* ─── HOW IT WORKS ─── */}
      <section id="process" style={{ background: `linear-gradient(165deg, ${COLORS.darkGreen}, ${COLORS.midGreen})`, padding: "100px 24px", position: "relative" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          <FadeIn>
            <div style={{ textAlign: "center", marginBottom: 64 }}>
              <div className="section-label">Process</div>
              <h2 className="section-title-white">How it works</h2>
              <p className="sans" style={{ fontSize: 16, color: COLORS.paleGreen, maxWidth: 500, margin: "0 auto" }}>
            ...
            {steps.map((s, i) => (
              <FadeIn key={i} delay={i * 0.1}>
                <div style={{ textAlign: "center", position: "relative" }}>
                  ...
                  <p className="sans" style={{ fontSize: 13, color: COLORS.paleGreen, lineHeight: 1.6 }}>{s.desc}</p>
                </div>
              </FadeIn>
            ))}
          </div>

          {/* Supplier → Asaase → Buyer diagram */}
          <FadeIn delay={0.4}>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 20, marginTop: 64, flexWrap: "wrap" }}>
              <div style={{ background: COLORS.softGreen, borderRadius: 12, padding: "24px 32px", textAlign: "center", minWidth: 180 }}>
              ...
              <ArrowIcon />
              <div style={{ background: COLORS.gold, borderRadius: 12, padding: "24px 32px", textAlign: "center", minWidth: 200, boxShadow: "0 8px 32px rgba(212,160,23,0.3)" }}>
              ...
              <ArrowIcon />
              <div style={{ background: "#FFF8E1", borderRadius: 12, padding: "24px 32px", textAlign: "center", minWidth: 180 }}>
      ...
      {/* ─── CONTACT ─── */}
      <section id="contact" style={{ background: `linear-gradient(165deg, ${COLORS.darkGreen}, #163728)`, padding: "100px 24px", position: "relative" }}>
        <div className="hero-pattern" />
        <div style={{ maxWidth: 700, margin: "0 auto", textAlign: "center", position: "relative", zIndex: 1 }}>
          <FadeIn>
            <GlobeIcon size={56} color={COLORS.gold} />
            <h2 style={{ fontSize: "clamp(28px, 4vw, 44px)", fontWeight: 700, color: COLORS.white, marginTop: 24, marginBottom: 12 }}>Let's talk</h2>
            <p className="sans" style={{ fontSize: 17, color: COLORS.paleGreen, marginBottom: 48, lineHeight: 1.7 }}>
          ...
          <FadeIn delay={0.2}>
            <div style={{ background: "rgba(255,255,255,0.06)", borderRadius: 16, padding: "40px 32px", backdropFilter: "blur(8px)", border: "1px solid rgba(255,255,255,0.08)" }}>
              <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
                {[
                  { label: "Email", value: "info@asaasetrading.com", icon: "✉" },
                  { label: "Phone", value: "+233 50 899 7104", icon: "☎" },
                  ...
                  <div key={i} style={{ display: "flex", alignItems: "center", gap: 16, justifyContent: "center" }}>
                    ...
                    <div style={{ textAlign: "left" }}>
                      ...
                      <div className="sans" style={{ fontSize: 16, color: COLORS.white }}>{c.value}</div>
                    </div>
                  </div>
                ))}
              </div>
      ...
      {/* ─── FOOTER ─── */}
      <footer style={{ background: "#0F2B1E", padding: "32px 24px", borderTop: `3px solid ${COLORS.gold}` }}>
